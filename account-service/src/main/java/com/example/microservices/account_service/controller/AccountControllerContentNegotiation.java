...
import com.example.microservices.account_service.dto.Accountv1DTO;
import com.example.microservices.account_service.dto.Accountv2DTO;
import com.example.microservices.account_service.dto.Accountv3DTO;
...
public class AccountControllerContentNegotiation {
	
    private final AccountService accountService;
    
    @Autowired
    public AccountControllerContentNegotiation(AccountService accountService) {
        this.accountService = accountService;
    }

    
 // Example for v1
    @GetMapping(value = "/{id}", produces = "application/vnd.bankapp.v1+json")
    public Accountv1DTO getAccountv1(@PathVariable Long id) {
        // Dummy data for testing
        Accountv1DTO dto = new Accountv1DTO();
        dto.setId(id);
        dto.setCustomerId(100L);
        dto.setAccountNo("123456");
        dto.setBalance(new BigDecimal("5000.00"));
        return dto;
    }

    // Example for v2
    @GetMapping(value = "/{id}", produces = "application/vnd.bankapp.v2+xml")
    public Accountv2DTO getAccountV2(@PathVariable Long id) {
        // Dummy data for testing
        Accountv2DTO dto = new Accountv2DTO();
        dto.setId(id);
        dto.setCustomerId(100L);
        dto.setAccountNo("123456");
        dto.setBalance(new BigDecimal("5000.00"));
 ...
 // Example for v3
    ...
    public Accountv3DTO getAccountV3(@PathVariable Long id) {
        // Dummy data for testing
        Accountv3DTO dto = new Accountv3DTO();
        dto.setId(id);
        dto.setCustomerId(100L);
        dto.setAccountNo("123456");
        dto.setBalance(new BigDecimal("5000.00"));
